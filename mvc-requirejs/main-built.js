...
define('tracklist',['tracklist'], function(tracklist) {
var tracklist = {
	"tracks": [
		{
			url: "assets/track1.mp3",
			title: "01 Fahrenheit fair enough",
			artist: "Telephone Tel Aviv",
			genre: "Electronic",
			album: "Telephone Tel Aviv"
		},
		{
		...
		{
			url: "assets/track3.mp3",
			title: "03 lotus above water",
			artist: "Telephone Tel Aviv",
			genre: "Electronic",
			album: "Fahrenheit fair enough"
		},
		{
			...
			title: "04 john thomas on the inside is noth",
			artist: "Telephone Tel Aviv",
			genre: "Electronic",
			album: "Fahrenheit fair enough"
		},
		{
			...
			title: "05 life is all about taking things i",
			artist: "Telephone Tel Aviv",
			genre: "Electronic",
			album: "Fahrenheit fair enough"
		},
		{
			...
			title: "06 your face reminds me of when i was young",
			artist: "Telephone Tel Aviv",
			genre: "Electronic",
			album: "Fahrenheit fair enough"
		}
...
define('model',['jQuery', 'tracklist'], function($,tracklist) {
...
define('draggable',['jQuery'], function($) {
...
define('views/ControlView',['jQuery'], function($) {
...
define('views/ProgressView',['jQuery', 'slider'], function($, slider) {
...
define('views/TrackListView',['jQuery'], function($) {
...
define('views/TrackInfoView',['jQuery'], function($) {
...
define('views/VolumeView',['jQuery', 'slider'], function($, slider) {
...
require.config({
	...
	paths: {
        ...
        'bootstrap': '../vendor/bootsrap/js/bootstrap.min.js'
	}/*,
	shim: {
		'jQuery': {
			exports: '$'
...
require(['jQuery', 'model', 'controller', 'draggable',
	'views/ControlView', 'views/ProgressView', 'views/TrackListView', 'views/TrackInfoView', 'views/VolumeView'],

	function($, PlayerModel, PlayerController, draggable, ControlView, ProgressView, TrackListView, TrackInfoView, VolumeView) {
